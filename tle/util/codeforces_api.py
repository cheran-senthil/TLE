                ...
                if r[0].newRating <= 1200:
                    for ind in range(0, (min(6, len(r)))):
                        r[ind] = RatingChange(
                            ...
                            r[ind].handle,
                            r[ind].rank,
                            r[ind].ratingUpdateTimeSeconds,
                            r[ind].oldRating + adaptO[ind],
                            r[ind].newRating + adaptN[ind],
                        )
                else:
                    r[0] = RatingChange(
                        r[0].contestId,
        ...
        for r in resp:
            ...
            for ind in range(0, len(r)):
                r[ind] = RatingChange(
                    ...
                    r[ind].ratingUpdateTimeSeconds,
                    oldPerf,
                    r[ind].oldRating + 4 * (r[ind].newRating - r[ind].oldRating),
                )
